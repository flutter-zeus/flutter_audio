...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result
{
    ...
    else if ([@"player.volume" isEqualToString:call.method])
    {
        NSLog(@"volume = %.20f", [call.arguments[@"volume"] doubleValue]);
        [players[uid] volume:[call.arguments[@"volume"] doubleValue]];
        result(nil);
    }
